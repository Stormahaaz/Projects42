...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/30 17:36:25 by ccorsin           #+#    #+#             */
/*   Updated: 2018/01/11 18:19:55 by ccorsin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_conv1(t_flag *arg, va_list ap)
{
	if (arg->lg == 1)
		...
		return (ft_intm(va_arg(ap, unsigned int), arg));
	else if (arg->lg == 6)
...
static int		ft_conv2(t_flag *arg, va_list ap)
{
	if (arg->lg == 1)
		...
		return (ft_uintm(va_arg(ap, unsigned int), arg));
	else if (arg->lg == 6)
...
static int		ft_conv3(t_flag *arg, va_list ap)
{
	if (arg->lg == 1)
		...
		return (ft_uintmbase(va_arg(ap, unsigned int), arg));
	else if (arg->lg == 6)
