...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/30 09:18:38 by ccorsin           #+#    #+#             */
/*   Updated: 2018/01/30 14:15:36 by ccorsin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_intm(unsigned int n, t_flag *arg);
...
int				ft_uintm(unsigned int n, t_flag *arg);
int				ft_usizet(size_t n, t_flag *arg);
char			*ft_itoaintmax(unsigned int n);
...
int				ft_uintmbase(unsigned int n, t_flag *arg);
